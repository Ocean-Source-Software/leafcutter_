...
params.bamsDir = "/mnt/data/run/geuvadis"
params.annotation = "/mnt/data/gencode.v19.annotation.gtf.gz"
params.exons = "/mnt/data/gencode19_exons.txt.gz"
params.annotationDir = "/mnt/data/run/annotation_codes"
params.annotationCode = "gencode_hg19"

process makeJuncFiles {
  storeDir '/mnt/data/run/nxf-cache-leafcutter'
